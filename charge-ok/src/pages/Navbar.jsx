...
<Modal show={showAdminModal} onHide={handleCloseAdminModal} centered dialogClassName="admin-modal">
  <Modal.Header
    style={{ backgroundColor: "black", color: "white" }}
    closeButton
  >
  ...
  <Modal.Body style={{ backgroundColor: "black", color: "white", padding: "20px" }}>
    <Tabs
              ...
              {inbox.length > 0 ? (
                inbox.map((request, index) => (
                  ...
                  >
                    ...
                    <Button variant="success" size="sm" className="mt-2 me-2">
                      Approve
                    </Button>
                ...
                <p style={{ color: "white", padding: "10px" }}>No new requests.</p>
              )}
            </ListGroup>
            ))
          ) : (
