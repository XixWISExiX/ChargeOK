...
const FloatingMenu = forwardRef(
  (
    ...
    return (
      <div ref={ref} className="floating-menu-container">
                ...
                {routeError && (
                  <Accordion.Body>
                    <div className="red-text">
                      Please Enter in More Reasonable <b>Mileage</b> before
                      Route Submission or <b>Valid Address</b>. You might also
                      need to <b>Wait for your Currenct Location</b> to be
                      loaded in. If you can't, then you cannot reach your
                      destination.
                    </div>
                  </Accordion.Body>
                )}
